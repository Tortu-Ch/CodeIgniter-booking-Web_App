  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="form-group">
            ...
            <input type="text" class="form-control" maxlength="12" minlength="12" name="on_ob_number"  id="formClient-On_ob_numbe" required placeholder="YYYY/MM/0000" value="<?php echo $duty->on_ob_number ?>" />
          </div>
          <div class="form-group">
            ...
            data-rule-remote="<?php echo url('duty_book/checkoff') ?>" data-msg-remote="Oops! This OB Number already exists"
             id="formClient-Off_ob_number" required placeholder="YYYY/MM/0000"  />
          </div>

  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control date" name="onDutyTime" id="formClient-OnDutyTime" data-date-format="yyyy-mm-dd hh:ii" data-link-field="dtp_input1" autocomplete="off" required placeholder="Select Date" autofocus value="<?php echo $duty->onDutyTime ?>" readonly/>
      </div>
